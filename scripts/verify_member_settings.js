...
(async () => {
    ...
    try {
        ...
        // Inject Member Session Directly (Skip Login UI flake)
        ...
        // Go to Settings directly (should work because session is set)
        console.log('3. Navigating to Settings...');
        await page.goto('http://localhost:3008/settings');

        // Wait for profile header to ensure page loaded
        await page.waitForSelector('h1');

        // Check for Data Management
        console.log('4. Checking for Clear History...');
        // Wait a bit for React to render conditional sections
